...
const PopulationGrowthRate:number = 0.20;
const PopulationDeathRate:number = 0.10;
  ...
  create(g: Game) {
    ...
    this.endTurnButton.on("pointerup", () => {
      ...
      if(this.selectedChoices.length === 2) {
        ...
        console.log('You consumed ' + this.resources["Population"].value * FoodConsumptionRate + " this turn.");
        ...
        if (this.resources["Food"].value <= 0) {
          this.resources["Population"].value -= Math.floor(this.resources["Population"].value * PopulationDeathRate);
          console.log('Your people are staving and ' + Math.floor(this.resources["Population"].value * PopulationDeathRate) + " died");
